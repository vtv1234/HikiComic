...
class Comic extends Equatable {
  ...
  final String? differentNameComic;
  ...
  Comic copyWith({
    ...
    return Comic(
      ...
      differentNameComic: differentNameComic ?? this.differentNameComic,
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'comicId': comicId,
      'comicName': comicName,
      'differentNameComic': differentNameComic,
  ...
  factory Comic.fromMap(Map<String, dynamic> map) {
    return Comic(
      ...
      differentNameComic: map['differentNameComic'] != null
          ? map['differentNameComic'] as String
          : null,
      alternative:
