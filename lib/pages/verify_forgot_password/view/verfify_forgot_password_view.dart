...
import 'package:hikicomic/pages/verify_forgot_password/bloc/verify_forgot_password_bloc.dart';
...
class VerifyForgotPasswordScreen extends StatefulWidget {
  ...
  @override
  State<VerifyForgotPasswordScreen> createState() => _OTPScreen();
}

class _OTPScreen extends State<VerifyForgotPasswordScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        ...
        child:
            BlocConsumer<VerifyForgotPasswordBloc, VerifyForgotPasswordState>(
          listener: (context, state) {
            ...
            //   successSnakBar(success: state.message, duration: 5).show(context);
            //   // Future.delayed(
              ...
              child: SizedBox(
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    //           context.read<VerifyForgotPasswordBloc>().add(
                    ...
                    //           infoSnakBar(
                    //                   info:
                    //                       "Resend after ${30 - DateTime.now().difference(lastPressedAt).inSeconds} second",
                    //                   duration: 5)
                    //               .show(context);
                    //         }
                    ...
                    Container(
                      ...
                      child: TextButton(
                        onPressed: () {
                          ...
                          context.read<VerifyForgotPasswordBloc>().add(
                              SendOtpVerifyForgotPasswordEvent(
                                  widget.email!, textEditingController.text));
